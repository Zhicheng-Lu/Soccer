    ...
    if ($group != "-1") {
        ...
        foreach ($teams as $team_index=>$team) {
            ...
            echo '
                                    <tr style="font-weight: '.$font_weight.'; cursor: pointer;" onclick="open_modal(\''.str_replace("'", "\'", $temp_name).'\', '.$competition.')">
        ...
        echo '
                            ...
                            <div class="col-xl-80 offset-xl-1 col-120 offset-2 no-padding row">';
