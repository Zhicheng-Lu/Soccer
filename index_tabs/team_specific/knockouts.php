    ...
    foreach ($knockout_matches as $index => $match) {
        ...
        echo '
                            <div class="col-xl-38 offset-xl-0 col-lg-44 col-md-52 col-sm-90 col-120 offset-2 no-padding">
                                <div class="row">
                                    <div class="col-56" style="text-align: right; font-weight: '.$font_weight1.';">
                                        <a style="text-decoration: none; color: black; cursor: pointer" onclick="open_modal(\''.str_replace("'", "\'", $team1).'\', '.$competition.')">
                                    ...
                                    <div class="col-56" style="text-align: left; font-weight: '.$font_weight2.';">
                                        <a style="text-decoration: none; color: black; cursor: pointer" onclick="open_modal(\''.str_replace("'", "\'", $team2).'\', '.$competition.')">
