	...
	include("includes/team_modal/qualifications.php");
    include("includes/team_modal/group.php");
    include("includes/team_modal/knockouts.php");
    include("includes/team_modal/winners_cup_finals.php");
    ...
    include("includes/team_modal/display_result.php");
