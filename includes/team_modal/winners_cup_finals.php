    ...
    if ($finals) {
        ...
        echo '
                        <div class="row">
                            <div class="col-xl-12 col-md-18 col-sm-23 col-120">联合决赛：</div>
                            <div class="col-xl-50 col-md-70 col-sm-97 col-120" style="font-size: 12px;">
                                <a style="color: black; text-decoration: none; cursor: pointer;" href="competition.php?tournament=winners_cup&competition='.$competition.'&stage=knockout&round=finals" target="_blank">
                                    ...
                                    <div class="col-sm-95 col-120 no-padding">
                                        <div class="row">
                                            <div class="col-56" style="text-align: right; font-weight: '.$font_weight1.';">
                                                <a style="text-decoration: none; color: black;" href="index.php?tab=team&team_name='.$match["team1"].'" target="_blank"><img src="images/teams_small/'.$match["team1"].'.png" style="width: 14px; height: 14px;"> '.$chinese_name[$match["team1"]].'</a>
                                            </div>
                                            ...
                                            <div class="col-56" style="font-weight: '.$font_weight2.';">
                                                <a style="text-decoration: none; color: black;" href="index.php?tab=team&team_name='.$match["team2"].'" target="_blank">'.$chinese_name[$match["team2"]].' <img src="images/teams_small/'.$match["team2"].'.png" style="width: 14px; height: 14px;"></a>
                                            </div>
                                        </div>
                                    </div>';
