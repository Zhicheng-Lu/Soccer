        ...
        <div class="col-116 offset-2">
        	<table style="width: 100%; font-size: 14px;">
				...
				<tr>
					...
					$counter = club_participants($conn, $participants, $competition, 1, "", "", "", 12, 24, $counter, "large");
				}
				...
				<tr>
					...
					$counter = club_participants($conn, $participants, $competition, 1, "", "", "", 19, 32, $counter, "large");
				}
