...
<body>
                        ...
                        <nav class="site-navigation d-flex justify-content-end align-items-center">
                            <ul class="d-flex flex-column flex-lg-row justify-content-lg-end align-items-center">
                                ...
                                if ($tournament == "champions_league") {
                                    ...
                                    array_push($stages, array("stage"=>"diagram", "round"=>"", "chinese"=>"晋级路线图"));
                                }
                                ...
                                foreach ($stages as $_stage) {
                                    ...
                                    echo '
                                <li class="'.$class.'"><a id="header" href="competition.php?tournament='.$tournament.'&competition='.$competition.'&stage='.$_stage["stage"].($_stage["round"]==""? "":'&round='.$_stage["round"]).'">'.$_stage["chinese"].'</a></li>';
                                }
                                ?>
                            </ul>
                        </nav><!-- .site-navigation -->
    ...
    <?php
    include('competition_tabs/'.$stage.'.php');
    ?>
